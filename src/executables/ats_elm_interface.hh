...
// The interface imitates ats 'coordinator' very much. So the spec. are exactly same.
...
class Ats_elm_interface {

public:
  Ats_elm_interface(Teuchos::ParameterList& parameter_list,
...
private:
  ...
  Teuchos::RCP<Teuchos::ParameterList> ats_elm_interface_list_;
