...
def getExodusVersion():
    ...
    version_major = -1
    version_minor = -1
    with open(SEACAS_ROOT+"/include/exodusII.h") as header_file:
...
SEACAS_ROOT=os.path.join(os.environ["AMANZI_TPLS_DIR"],"SEACAS")
if os.uname()[0] == 'Darwin':
    EXODUS_SO = SEACAS_ROOT+"/lib/libexodus.dylib"
else:
    EXODUS_SO = SEACAS_ROOT+"/lib/libexodus.so"
